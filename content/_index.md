...
header:
  description: <span class="accent-text">Ascent Data Solutions</span> From data science implementations to customized Business Intelligence delivery.
  image:
    url: home-hero.png
    alt: The top of mountain image
    media: "(max-width: 46.25em)"
    params:
    - options: 1130x500 jpg00
    - options: 848x443 jpg
      cmd: Fit
    - options: 565x420 jpg
      cmd: Fit
